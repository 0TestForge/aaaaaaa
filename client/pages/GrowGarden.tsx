            ...
            {(() => {
              const Icon = (key: FilterKey) => {
                ...
                switch (key) {
                  ...
                  case "mutated":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#8b5cf6" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg width="35" height="35" xmlns="http://www.w3.org/2000/svg"><image href="https://cdn.builder.io/api/v1/image/assets%2F4443d55382a24e03a9e006085af8613b%2F2edc4326da1b449b8e47f9acedbaa62d?format=webp&width=800" width="35" height="35" preserveAspectRatio="xMidYMid slice" /></svg></g></svg>);
                  case "bundles":
          ...
          <div className="container py-2 best-scroll-wrapper relative">
            <div ref={bottomScrollRef} className="best-scroll flex items-center px-2 py-2 gap-1 overflow-x-auto">
              {[
                ...
                { key: 'mutated', label: 'Mutated Pets', color: 'text-violet-400 hover:bg-gradient-to-t hover:from-violet-500/10 hover:text-violet-300', rect: '#8b5cf6', stroke: '#8b5cf6' },
                        ...
                        <g transform="translate(4, 4)">
                          ...
                          {b.key === 'mutated' && (
                            <svg width="35" height="35" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6">
                              <image href="https://cdn.builder.io/api/v1/image/assets%2F4443d55382a24e03a9e006085af8613b%2F2edc4326da1b449b8e47f9acedbaa62d?format=webp&width=800" width="35" height="35" preserveAspectRatio="xMidYMid slice" />
                            </svg>
                          )}
                          {b.key === 'mega' && (
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke={b.stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6">
