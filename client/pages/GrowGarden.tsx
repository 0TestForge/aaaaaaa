...
export default function GrowGarden() {
  ...
  useEffect(() => {
    ...
    const onFilter = (e: Event) => {
      const key = (e as CustomEvent<FilterKey>).detail;
  ...
  useEffect(() => {
    if (cartOpen) setShowCartOverlay(true);
  }, [cartOpen]);
  ...
  const priceFmt = useMemo(
    () => new Intl.NumberFormat('en-US', { style: "currency", currency, currencyDisplay: 'narrowSymbol', minimumFractionDigits: 0, maximumFractionDigits: 0 }),
    [currency],
  );
  ...
  // Load admin custom products and deleted ids for Grow a Garden
  useEffect(() => {
    const keyC = "admin:customProducts:grow";
    const keyD = "admin:deletedIds:grow";
    const load = () => {
      try {
            ...
            <div className="hidden md:block w-full rounded-2xl border border-emerald-700/20 bg-emerald-900/20 p-4 fixed top-16 left-0 right-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-background/60">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" className={`px-2 py-2 text-white ${filter === "pets" ? "underline" : ""}`} onClick={() => setFilter("pets")}>
                    Pets
                  </Button>
                  ...
                  <Button variant="ghost" size="sm" className={`px-2 py-2 text-white ${filter === "mega" ? "underline" : ""}`} onClick={() => setFilter("mega")}>
                    Mega Pets
                  </Button>
                </div>
            ...
            <aside className="mobile-filters hidden md:hidden rounded-2xl border border-white/10 bg-slate-900/60 p-2 min-h-[calc(100vh-6rem)]">
              <div className="sticky top-20 space-y-2">
                <div className="flex items-center gap-2 rounded-md bg-slate-900/80 text-white border border-white/10 px-2 py-1">
                  <img src="https://cdn.builder.io/api/v1/image/assets%2Fb2458d5aab5847128a2b754080dc1712%2F824f285113f54ff094f70b7dac6cb138?format=webp&width=400" alt="Grow a Garden" className="h-7 w-10 rounded object-cover" />
                  <span className="font-semibold text-xs sm:text-sm">Grow a Garden</span>
                </div>
                ...
                <div className="grid gap-2">
                  ...
                  <Button className="filter-custom justify-start w-full px-3 py-2 bg-transparent hover:bg-transparent border-0 shadow-none text-white" size="sm" onClick={() => setFilter("pets")}>
                    Pets
                  </Button>
                  ...
                  <Button className="filter-custom justify-start w-full px-3 py-2 bg-transparent hover:bg-transparent border-0 shadow-none text-white" size="sm" onClick={() => setFilter("mega")}>
                    Mega Pets
                  </Button>
                </div>
                  <div className="pt-2">
            ...
            {(() => {
              const Icon = (key: FilterKey) => {
                ...
                switch (key) {
                  ...
                  case "pets":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.7 13.5c-1.1 -2 -1.441 -2.5 -2.7 -2.5c-1.259 0 -1.736 .755 -2.836 2.747c-.942 1.703 -2.846 1.845 -3.321 3.291c-.097 .265 -.145 .677 -.143 .962c0 1.176 .787 2 1.8 2c1.259 0 3 -1 4.5 -1s3.241 1 4.5 1c1.013 0 1.8 -.823 1.8 -2c0 -.285 -.049 -.697 -.146 -.962c-.475 -1.451 -2.512 -1.835 -3.454 -3.538z"></path><path d="M20.188 8.082a1.039 1.039 0 0 0 -.406 -.082h-.015c-.735 .012 -1.56 .75 -1.993 1.866c-.519 1.335 -.28 2.7 .538 3.052c.129 .055 .267 .082 .406 .082c.739 0 1.575 -.742 2.011 -1.866c.516 -1.335 .273 -2.7 -.54 -3.052z"></path><path d="M9.474 9c.055 0 .109 0 .163 -.011c.944 -.128 1.533 -1.346 1.32 -2.722c-.203 -1.297 -1.047 -2.267 -1.932 -2.267c-.055 0 -.109 0 -.163 .011c-.944 .128 -1.533 1.346 -1.32 2.722c.204 1.293 1.048 2.267 1.933 2.267z"></path><path d="M16.456 6.733c.214 -1.376 -.375 -2.594 -1.32 -2.722a1.164 1.164 0 0 0 -.162 -.011c-.885 0 -1.728 .97 -1.93 2.267c-.214 1.376 .375 2.594 1.32 2.722c.054 .007 .108 .011 .162 .011c.885 0 1.73 -.974 1.93 -2.267z"></path><path d="M5.69 12.918c.816 -.352 1.054 -1.719 .536 -3.052c-.436 -1.124 -1.271 -1.866 -2.009 -1.866c-.14 0 -.277 .027 -.407 .082c-.816 .352 -1.054 1.719 -.536 3.052c.436 1.124 1.271 1.866 2.009 1.866c.14 0 .277 -.027 .407 -.082z"></path></svg></g></svg>);
                  case "mutated":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.12"></rect><g transform="translate(4, 4)"><svg width="35" height="35" xmlns="http://www.w3.org/2000/svg"><image href="https://cdn.builder.io/api/v1/image/assets%2F4443d55382a24e03a9e006085af8613b%2F2edc4326da1b449b8e47f9acedbaa62d?format=webp&width=800" width="35" height="35" preserveAspectRatio="xMidYMid slice" style={{ filter: 'brightness(1.6) saturate(1.2)', opacity: 0.95 }} /></svg></g></svg>);
                  case "bundles":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19.5 12.572l-7.5 7.428l-7.5 -7.428a5 5 0 1 1 7.5 -6.566a5 5 0 1 1 7.5 6.572"></path></svg></g></svg>);
                  case "sheckle":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0"></path><path d="M14.8 9a2 2 0 0 0 -1.8 -1h-2a2 2 0 1 0 0 4h2a2 2 0 1 1 0 4h-2a2 2 0 0 1 -1.8 -1"></path><path d="M12 7v10"></path></svg></g></svg>);
                  case "fruits":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 12m-3 0a3 3 0 1 0 6 0a3 3 0 1 0 -6 0"></path><path d="M12 2a3 3 0 0 1 3 3c0 .562 -.259 1.442 -.776 2.64l-.724 1.36l1.76 -1.893c.499 -.6 .922 -1 1.27 -1.205a2.968 2.968 0 0 1 4.07 1.099a3.011 3.011 0 0 1 -1.09 4.098c-.374 .217 -.99 .396 -1.846 .535l-2.664 .366l2.4 .326c1 .145 1.698 .337 2.11 .576a3.011 3.011 0 0 1 1.09 4.098a2.968 2.968 0 0 1 -4.07 1.098c-.348 -.202 -.771 -.604 -1.27 -1.205l-1.76 -1.893l.724 1.36c.516 1.199 .776 2.079 .776 2.64a3 3 0 0 1 -6 0c0 -.562 .259 -1.442 .776 -2.64l.724 -1.36l-1.76 1.893c-.499 .601 -.922 1 -1.27 1.205a2.968 2.968 0 0 1 -4.07 -1.098a3.011 3.011 0 0 1 1.09 -4.098c.374 -.218 .99 -.396 1.846 -.536l2.664 -.366l-2.4 -.325c-1 -.145 -1.698 -.337 -2.11 -.576a3.011 3.011 0 0 1 -1.09 -4.099a2.968 2.968 0 0 1 4.07 -1.099c.348 .203 .771 .604 1.27 1.205l1.76 1.894c-1 -2.292 -1.5 -3.625 -1.5 -4a3 3 0 0 1 3 -3z"></path></svg></g></svg>);
                  case "mega":
                    return (<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden><rect width="42" height="42" rx="10" fill="#22c55e" fillOpacity="0.1"></rect><g transform="translate(4, 4)"><svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round"><path d="M6 5h12l3 5l-8.5 9.5a.7 .7 0 0 1 -1 0l-8.5 -9.5l3 -5"></path><path d="M10 12l-2 -2.2l.6 -1"></path></svg></g></svg>);
                  default:
                    return null;
                }
              };
                  ...
                  <div className="mb-10">
                    <div className="mb-3 flex items-center gap-3">
                      ...
                      <div className="ml-auto flex items-center gap-12">
                        <button
                          type="button"
                          onClick={() => navigate(`/grow/all?filter=${fkey}`)}
                    ...
                    <div ref={wrapperRef} className="best-scroll-wrapper relative">
                      <button type="button" aria-label="Scroll left" className={`absolute left-2 top-1/2 -translate-y-1/2 z-20 rounded-full bg-input border-border border-[2px] text-white p-2 hidden md:flex items-center justify-center ${isScrollable ? 'md:flex' : 'hidden'}`} onClick={() => {
                        const scrollEl = wrapperRef.current?.querySelector('.best-scroll') as HTMLElement | null;
                        if (!scrollEl) return; scrollEl.scrollBy({ left: -Math.round(scrollEl.clientWidth * 0.7), behavior: 'smooth' });
                      }} >&lt;</button>
                      <button type="button" aria-label="Scroll right" className={`absolute right-2 top-1/2 -translate-y-1/2 z-20 rounded-full bg-input border-border border-[2px] text-white p-2 hidden md:flex items-center justify-center ${isScrollable ? 'md:flex' : 'hidden'}`} onClick={() => {
                        const scrollEl = wrapperRef.current?.querySelector('.best-scroll') as HTMLElement | null;
                        if (!scrollEl) return; scrollEl.scrollBy({ left: Math.round(scrollEl.clientWidth * 0.7), behavior: 'smooth' });
                      }} >&gt;</button>
...
<div role="button" tabIndex={0} className="absolute right-0 bottom-0 left-0 hidden md:flex translate-y-full cursor-pointer items-center justify-center bg-gradient-to-t from-[#141425]/90 via-[#141425]/50 to-transparent p-4 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100">
              ...
              if (filter === "all") {
                const order: FilterKey[] = ["best", "pets", "mutated", "bundles", "sheckle", "fruits", "mega"];
                return (
                  <div>
                    {order.map((key) => {
          ...
          <div className="container py-2 best-scroll-wrapper relative">
            <div ref={bottomScrollRef} className="best-scroll flex items-center px-2 py-2 gap-1 overflow-x-auto">
              {[
                ...
                { key: 'mutated', label: 'Mutated Pets', color: 'text-emerald-400 hover:bg-gradient-to-t hover:from-emerald-500/10 hover:text-emerald-300', rect: '#22c55e', stroke: '#86efac' },
                    ...
                    <div className="scale-75">
                      <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <g transform="translate(4, 4)">
                          ...
                          {b.key === 'mutated' && (
                            <svg width="35" height="35" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6">
                              <image href="https://cdn.builder.io/api/v1/image/assets%2F4443d55382a24e03a9e006085af8613b%2F2edc4326da1b449b8e47f9acedbaa62d?format=webp&width=800" width="35" height="35" preserveAspectRatio="xMidYMid slice" style={{ filter: 'brightness(1.6) saturate(1.2)', opacity: 0.95 }} />
                            </svg>
                          )}
                          {b.key === 'mega' && (
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24" fill="none" stroke={b.stroke} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-6 w-6">
                ...
                <div className="mt-4 flex flex-col items-center gap-4">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      try {
                        const lines = groupedCart.map((l) => ({
                          id: l.id,
                          name: l.item.name,
                          qty: l.qty,
                          priceLocal: Math.round(toLocal((overrides[l.id] ?? l.item.priceUSD) * l.qty)),
                          thumb: l.item.image,
                        }));
                    ...
                    className="w-full mt-2 rounded-lg bg-rose-700 hover:bg-rose-800 text-white py-3 flex items-center justify-center gap-2"
                  >
        ...
        {/* Mobile cart button (phones) — styled per provided design */}
